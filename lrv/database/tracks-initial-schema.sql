...
CREATE TABLE `tracksarchive` (
  ...
  `airspacecheck` int(11) DEFAULT '0',
  `airspacebreach` int(11) DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
  UNIQUE KEY `glider` (`glider`,`point_time`,`point_time_milli`)
) ENGINE=InnoDB AUTO_INCREMENT=826477 DEFAULT CHARSET=latin1;
...
-- Dump completed on 2018-01-17  8:36:21
