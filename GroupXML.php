...
$con=mysqli_connect($con_params['hostname'],$con_params['username'],$con_params['password'],$con_params['dbname']);
    ...
    {  
      ...
      $sql= "SELECT members.id,members.displayname,membership_class.disp_message_broadcast FROM members LEFT JOIN membership_class ON membership_class.id = members.class WHERE membership_class.disp_message_broadcast = 1 and members.org = " .$org. " ORDER BY surname,firstname ASC";
